...
namespace AutoFake.UnitTests
{
    public class MockedMemberInfoTests
    {
        ...
        public void GenerateFieldName_Setup_ReturnsCorrectFieldName()
        {
            ...
            var memberInfo = new MockedMemberInfo(new ReplaceMock(expressionMock.Object), "suffix");

            Assert.Equal("SystemInt32_Test_SystemObject_suffix", memberInfo.UniqueName);
        }
